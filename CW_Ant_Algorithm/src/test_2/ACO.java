...
public class ACO {
    ...
    public void InitInfo(double value, double teta_value) {
        ...
        for (int i = 1; i < init.N + 20; i++) {
            if (Main_function.min_route[i] == 0 || Main_function.min_route[i + 1] == 0) {
                break;
            }
            info[Main_function.min_route[i] - 1][Main_function.min_route[i + 1]
                    - 1] = info[Main_function.min_route[i] - 1][Main_function.min_route[i + 1] - 1] + teta_value;
            info[Main_function.min_route[i + 1] - 1][Main_function.min_route[i]
                    - 1] = info[Main_function.min_route[i] - 1][Main_function.min_route[i + 1] - 1];
        }
